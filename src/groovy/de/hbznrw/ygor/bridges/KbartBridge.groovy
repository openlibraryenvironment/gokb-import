...
import de.hbznrw.ygor.interfaces.AbstractBridge
import de.hbznrw.ygor.interfaces.BridgeInterface
import groovy.util.logging.Log4j

@Log4j
/**
 * Brücke, die eine Klammer zwischen Anreicherungs-Thread, dem KBART-Prozessor und dem KBART-Connector bildet.
 */
class KbartBridge extends AbstractBridge implements BridgeInterface {
  ...
  void processStash() throws Exception {
    ...
    stash.get(this.stashIndex).each { uid, fields ->
      ...
      log.info("working on: " + fields.get("publication_title"))

...
class EzbReader extends AbstractReader {
  ...
  static {
    QUERY_IDS.put(KbartReader.KBART_HEADER_ZDB_ID, "jq_type1=ZD&jq_term1=")
    QUERY_IDS.put(KbartReader.KBART_HEADER_ONLINE_IDENTIFIER, "jq_type1=IS&jq_term1=")
    QUERY_IDS.put(KbartReader.KBART_HEADER_PRINT_IDENTIFIER, "jq_type1=IS&jq_term1=")
  }

...
class JsonTransformer {
    ...
    static Object parseNominalPlatform(Object json) {
        ...
        def plt = [
          ...
          'primaryUrl': json.package.packageHeader.nominalPlatform.primaryUrl?json.package.packageHeader.nominalPlatform.primaryUrl:json.package.packageHeader.nominalPlatform.url
        ]
